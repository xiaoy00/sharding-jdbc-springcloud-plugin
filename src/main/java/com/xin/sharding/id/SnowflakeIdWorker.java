 ...
 */
public class SnowflakeIdWorker implements KeyGenerator {
    // ==============================Fields===========================================
    /** 开始时间截 (2015-01-01) */
     ...
     * @return
     */
    public static SnowflakeIdWorker getInstanceSnowflake(Integer workerId) {
